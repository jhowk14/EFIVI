...
const App = () => {
    const itensMenu = [
        { label: 'Item 1', onClick: () => console.log('Clicou no Item 1') },
        { label: 'Item 2', onClick: () => console.log('Clicou no Item 2') },
        { label: 'Item 3', onClick: () => console.log('Clicou no Item 3') },
        { label: 'Item 4', onClick: () => console.log('Clicou no Item 4') },
        { label: 'Item 5', onClick: () => console.log('Clicou no Item 5') },
        { label: 'Item 6', onClick: () => console.log('Clicou no Item 6') },
        { label: 'Item 7', onClick: () => console.log('Clicou no Item 7') },
        { label: 'Item 8', onClick: () => console.log('Clicou no Item 8') }
    ];
