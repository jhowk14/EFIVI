    ...
    return (
     <>
        ...
        <div className="p-content1">
            ...
            <Carolsel images={[
                {src: '/img/assets/img7.png', alt:'sala de aula vazia'},
                {src: '/img/assets/img2.png', alt:'sala de aula com alunos (vista de trás)'},
                {src: '/img/assets/img10.png', alt:'sala de aula com alunos (vista de frente)'},
            ]}/>
            <div className="p-desc">
            ...
            <Carolsel images={[
                {src: '/img/assets/img9.png', alt:'sala com computadores vazia'},
                {src: '/img/assets/img6.png', alt:'sala com computadores com alunos'},
            ]}/>
            <div className="p-desc">
            ...
            <Carolsel images={[
                {src: '/img/assets/img8.png', alt:'bancadas de trabalho vazias'},
                {src: '/img/assets/img4.png', alt:'bancadas de trabalho com alunos (vista de trás)'},
                {src: '/img/assets/img3.png', alt:'alunos e professores do Senac'},
                {src: '/img/assets/img11.png', alt:'Heraldo e aluno do senac'},
                {src: '/img/assets/img12.png', alt:'bancadas de trabalho com alunos (vista de lado)'},
                {src: '/img/assets/img14.png', alt:'descartes eletronicos'},
            ]}/>
            <div className="p-desc">
