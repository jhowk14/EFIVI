     ...
     <>
        ...
        <div className="info1">
            <div className="p-content1">
                ...
                <Carousel2 images={[
                    {src: '/img/assets/img5.png', alt:'Heraldo e aluno', descricão: 'Como metodologia, todo aprendizado de eletrônica é baseado na estrutura de funcionamento de uma fonte de alimentação de computador (ATX), onde são abordados o funcionamento de cada componente, suas características, símbolos e aplicações.'},
                    {src: '/img/assets/img1.png', alt:'bancadas de trabalho com alunos (vista de frente)', descricão: 'Esse curso tem o objetivo de capacitar os alunos e alunas na manutenção e reparação de computadores de mesa e notebook, assim como também em seus periféricos (teclado, mouse, monitor, impressora, no-break, etc.).'},
                    {src: '/img/assets/img15.png', alt:'Heraldo com descartes eletronicos', descricão: 'Nosso objetivo também é o de atender outras entidades assistenciais no fornecimento de equipamentos de informática gratuitamente. Além de recolher, recuperar, reciclar e destinar ecologicamente equipamentos de informática, eletrônica, elétricos, telefônicos, etc., visando a redução do impacto ambiental da sucata tecnológica.'},
                    {src: '/img/assets/img13.png', alt:'doação de descartes eletrônicos', descricão: 'Esse projeto não inclui o deficiente visual de forma direta , ele é apenas beneficiado pelo resultado do projeto que proporcionará o fornecimento de computador e seus periféricos gratuitamente para que ele que possa “ler um livro”, interagir no mundo digital (enviar e receber email, pesquisar na internet entre outras atividades proporcionadas por aplicativos como o DOSVOX, VIRTUAL VISION, JAWS, entre outros).'},
                ]}/>
                <div className="video">
